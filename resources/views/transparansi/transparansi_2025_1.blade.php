    ...
    <div class="headerrr">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td class="justify-text">Raperda tentang APBD Tahun 2025</td>
            ...
            <tbody>
                <tr>
                    <td>2</td>
                    <td class="justify-text">Perda tentang APBD Tahun 2025</td>
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2025/PERDA_APBD_2025.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    <td>3</td>
                    <td class="justify-text">Rencana Kerja Pemerintah Daerah (RKPD) Tahun 2025</td>
                    <td><a href=""><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    <td>4</td>
                    <td class="justify-text">Ringkasan Penjabaran APBD  Tahun 2025 Level Jenis</td>
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2025/Ringkasan_LevelJenis.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    <td>5</td>
                    <td class="justify-text">Ringkasan Penjabaran APBD Tahun 2025 Level Rincian</td>
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2025/Ringkasan_LevelRincian.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    <td>6</td>
                    <td class="justify-text">Ringkasan Penjabaran APBD Tahun 2025 Menurut Urusan</td>
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2025/Ringkasan_menurutUrusan.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </tbody>
            <tbody>
                <tr>
                    <td>7</td>
                    <td class="justify-text">Perwali Tentang Penjabaran APBD Tahun 2025</td>
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2025/PERWALI_APBD_2025.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
            </tbody>
        </table>
</section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7977.66972300458!2d116.8307189!3d-1.2721786!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df1473bb9404897%3A0x94d96108f98b652c!2sBalikpapan%20Mayor&#39;s%20Office!5e0!3m2!1sen!2sid!4v1739180593156!5m2!1sen!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
