...
<div class="containerr">
    <h1>Pergeseran Anggran Tahun 2020</h1>
        <div class="document">
            <h2>Pergeseran Pertama</h2>
            <div class="document">
                <h2>Perubahan Pertama Perwal APBD 2020</h2>
                <div class="buttons">
                    <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/Perubahan%20Pertama%20Perwal%20APBD%202020_1.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </div>
            </div>
                <div class="document">
                    <h2>Lampiran 1 Rinci</h2>
                    <div class="buttons">
                        <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/Lampiran%20I%20-%20Rinci%202020_1.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                    </div>
                </div>
                <div class="document">
                    <h2>Lampiran 1 Jenis</h2>
                    <div class="buttons">
                        <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/Lampiran%20I%20-%20JENIS%20%202020_1.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                    </div>
                </div>
            </div>
        <div class="document">
            <h2>Pergeseran Kedua</h2>
            <div class="document">
                <h2>Perubahan Kedua Perwal APBD 2020</h2>
                <div class="buttons">
                    <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/Perubahan%20Kedua%20Perwal%20APBD%202020_2.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </div>
            </div>
                <div class="document">
                    <h2>Lampiran 1 Rinci</h2>
                    <div class="buttons">
                        <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/RINGKASAN%20LEVEL%20RINCI%202020_2.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                    </div>
                </div>
                <div class="document">
                    <h2>Lampiran 1 Jenis</h2>
                    <div class="buttons">
                        <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/RINGKASAN%20LEVEL%20JENIS%202020_2.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                    </div>
                </div>
            </div>
            <div class="document">
            <h2>Pergeseran Ketiga</h2>
            <div class="document">
                 <h2>Perubahan Ketiga Perwal APBD 2020</h2>
                 <div class="buttons">
                     <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/Perubahan%20Ketiga%20Perwal%20APBD%202020_3.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                 </div>
                </div>
                <div class="document">
                    <h2>Lampiran 1 Rinci</h2>
                    <div class="buttons">
                        <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/Lampiran%20I%20Level%20Rinci%202020_3.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                    </div>
                </div>
                <div class="document">
                    <h2>Lampiran 1 Jenis</h2>
                    <div class="buttons">
                        <a href="http://web.balikpapan.go.id/uploaded/PERGESERAN/Lampiran%20I%20Level%20Jenis_3.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                    </div>
                </div>
            </div>
</section>
