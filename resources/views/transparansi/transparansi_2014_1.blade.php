...
<style>
  ...
  <main class="main">
    ...
    <div class="headerrr">
        ...
        <h2>Rencana Kegiatan Anggaran (RKA) SKPD Kota Balikpapan Tahun 2014</h2>
        <table>
            <thead>
                <tr>
                    <th>No</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/lakip2014/SEKRETARIAT.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    ...
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/lakip2014/SEKWAN_BALIKPAPAN.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2014/1_RKA_SKPD_2014/1.01.01.DINAS_PENDIDIKAN.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
                </tr>
                <tr>
                    <td>2</td>
                    <td class="justify-text">Dinas Kesehatan</td>
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2014/1_RKA_SKPD_2014/1.02.01.DINAS_KESEHATAN_KOTA.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
                </tr>
                <tr>
                    <td>3</td>
