...
<div class="containerr">
    <h1>Informasi SK Kepala Daerah Tentang Pejabat Pengelola Keuangan Daerah 2023</h1>
        <div class="document">
            <h2>SK Pengguna Anggaran 20233</h2>
            <div class="buttons">
                <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2023/SK%20Pelimpahan%20Kewenangan%20Walikota%20Kepada%20PA.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </div>
        </div>
        <div class="document">
            <h2>SK Kuasa Pengguna Anggaran 2023</h2>
            <div class="buttons">
                <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2023/SK%20Pelimpahan%20Wewenang%20PA%20ke%20KPA%20TA.%202023.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </div>
        </div>
</section>
