...
<div class="containerr">
    <h1>Informasi SK Kepala Daerah Tentang Pejabat Pengelola Keuangan Daerah 2023</h1>
        <div class="document">
            <h2>Rancangan Perda tentang APBD Tahun 2022</h2>
            <div class="document">
                <h2>Rancangan Perda tentang APBD Tahun 2022</h2>
                <div class="buttons">
                    <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/laporankeuangan2022/RAPERDA%202022%20(BATANG%20TUBUH).pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </div>
            </div>
            <div class="document">
                <h2>Berita Acara Raperda APBD Tahun 2022 antara DPRD dan Wali Kota</h2>
                <div class="buttons">
                    <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2023/BERITA%20ACARA%20PERSETUJUAN%20BERSAMA%20KEPALA%20DAERAH%20DAN%20DPRD.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </div>
            </div>
        </div>
        <div class="document">
            <h2>Perda tentang APBD Tahun 2022</h2>
            <div class="buttons">
                <a href="http://web.balikpapan.go.id/uploaded/ProgramKerja/laporankeuangan2022/Perda_APBD_2022.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </div>
        </div>
        <div class="document">
            <h2>Ringkasan Penjabaran APBD  Tahun 2022 Level Jenis</h2>
            <div class="buttons">
                <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/laporankeuangan2022/APBD_LEVEL_JENIS.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </div>
        </div>
        <div class="document">
            <h2>Ringkasan Penjabaran APBD Tahun 2022 Level Rincian</h2>
            <div class="buttons">
                <a href="#"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </div>
        </div>
        <div class="document">
            <h2>Ringkasan Penjabaran APBD Tahun 2022 Menurut Urusan</h2>
            <div class="buttons">
                <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/laporankeuangan2022/APBD_URUSAN_PEMERINTAH.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </div>
        </div>
        <div class="document">
            <h2>Perwali Tentang Penjabaran APBD Tahun 2022</h2>
            <div class="buttons">
                <a href="http://web.balikpapan.go.id/uploaded/ProgramKerja/laporankeuangan2022/Perwali_APBD_2022.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </div>
        </div>
        <div class="document">
            <h2>SK Pelimpahan Kewenangan KDH 2022</h2>
            <div class="buttons">
                <a href="http://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2022/2022_%20SK%20Pelimpahan%20Kewenangan%20KDH%202022.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
            </div>
        </div>
</section>
