...
<div class="containerr">
    <h1>Perubahan APBD Tahun 2022</h1>
        <div class="document">
            <h2>Perubahan RAPBD Kota Balikpapan Tahun Anggaran 2022</h2>
            <div class="document">
                <h2>Raperda Perubahan Anggaran Pendapatan dan Belanja Daerah Tahun Anggaran 2022</h2>
                <div class="buttons">
                    <a href="http://web.balikpapan.go.id/uploaded/ProgramKerja/laporankeuangan2022/14_Raperda%20Tentang%20Perubahan%20APBD%202022.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </div>
            </div>
            <div class="document">
                <h2>Ringkasan RKA Perubahan Anggaran Pendapatan dan Belanja Daerah Tahun Anggaran 2022</h2>
                <div class="buttons">
                    <a href="https://web.balikpapan.go.id/detail/read/58966/ringkasan-rka-perubahan-anggaran-pendapatan-dan-belanja-daerah-tahun-anggaran-2022"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </div>
            </div>
        </div>
        <div class="document">
            <h2>Perubahan APBD Tahun 2022</h2>
                <div class="document">
                    <h2>Perda Perubahan APBD Tahun Anggaran 2022</h2>
                    <div class="buttons">
                        <a href="http://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2022/2022_%20PERDA%20PERUBAHAN%20APBD%20TA%202022.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                    </div>
                </div>
                <div class="document">
                    <h2>Perda Perubahan Penjabaran APBD Tahun Anggaran 2022</h2>
                    <div class="buttons">
                        <a href="http://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2023/PERWAL%20PERUBAHAN%20APBD%20TA%202022.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                    </div>
                </div>
            </div>
        </div>
