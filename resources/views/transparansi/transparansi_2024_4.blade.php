...
 });
  ...
  <main class="main">
    ...
    <div class="headerrr">
        ...
        <h2>PERUBAHAN ANGGARAN PENDAPATAN DAN BELANJA DAERAH TAHUN ANGGARAN 2024</h2>
        <table>
            <thead>
                <tr>
                    <th>No</th>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td class="justify-text">RAPERDA TENTANG PERUBAHAN ANGGARAN PENDAPATAN DAN BELANJA DAERAH
                        TAHUN ANGGARAN 2024</td>
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2024/Raperda%20Perubahan%202024.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
            </tbody>
            <tbody>
                <tr>
                    <td>2</td>
                    <td class="justify-text">PERDA TENTANG PERUBAHAN ANGGARAN PENDAPATAN DAN BELANJA DAERAH
                        TAHUN ANGGARAN 2024
                        </td>
                    <td><a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2024/PERDA%20PERUBAHAN%20APBD%20NOMOR%204%20TAHUN%202024.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </tr>
            </tbody>
        </table>
</section>
