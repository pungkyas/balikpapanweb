...
<style>
    ...
    /* struktur */
        ...
        /* Responsivitas untuk tablet (potret dan lanskap) */
        @media (max-width: 1024px) {
            .containerr {
                width: 95%;
            }
        ...
        /* Responsivitas untuk ponsel (potret) */
        @media (max-width: 768px) {
            ...
            .image-container {
                margin-bottom: 5px; /* Mengurangi jarak bawah pada layar kecil */
            }
        ...
        /* Responsivitas untuk ponsel kecil (potret & lanskap) */
        @media (max-width: 480px) {
            .containerr {
                padding: 5px;
            }
            ...
            .image-container {
                margin-bottom: 2px; /* Jarak bawah semakin kecil untuk layar kecil */
            }
  ...
  <main class="main">
    ...
    <div class="containerr">
        <div class="image-container">
            <img src="assets/img/struktur.jpeg" alt="Struktur Organisasi">
        </div>
    </div>
    </section>
