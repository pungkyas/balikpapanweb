...
<div class="containerr">
    <h1>Laporan Penyelenggaraan Pemerintahan Daerah Kota Balikpapan</h1>
    <div class="document">
        <h2>LPPD Kota Balikpapan Tahun 2020</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/PPID/LPPD%20Kota%20Balikpapan%20Tahun%202020.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>

    <div class="document">
        <h2>LPPD Kota Balikpapan Tahun 2021</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/PPID/LAPORAN%20LPPD%202021%20TERBARU.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>

    <div class="document">
        <h2>LPPD Kota Balikpapan Tahun 2022</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/tpad2022/LPPD%20TAHUN%202022%20FIX.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>
    <div class="document">
        <h2>LPPD Kota Balikpapan Tahun 2023</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/RLPPD_KOTA_BALIKPAPAN_2023.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>
</section>
