...
<main class="main">
    ...
    <div class="headerrr">
        ...
        <div class="containerr">
            <div class="document">
                <h2>Produk Domestik Bruto (PDRB) Kota Balikpapan Menurut Pengeluaran 2013-2017 </h2>
                <div class="buttons">
                    <a href="https://web.balikpapan.go.id/uploaded/Produk_Domestik_Regional_Bruto_Kota_Balikpapan_Menurut_Pengeluaran_2013-2017_.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </div>
            </div>

            <div class="document">
                <h2>Kota Balikpapan Dalam Angka Tahun 2018</h2>
                <div class="buttons">
                    <a href="https://web.balikpapan.go.id/uploaded/Kota_Balikpapan_Dalam_Angka_2018.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
                </div>
            </div>
    </section>
    <section>
