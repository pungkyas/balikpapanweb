...
<div class="containerr">
    <div class="document">
        <h2>REKAPITULASI ASET LAIN-LAIN TAHUN 2021</h2>
        <div class="buttons">
            <a href="http://web.balikpapan.go.id/uploaded/PPID/rekap%20neraca%20audited%202021,.pdf">
    ...
    <div class="document">
        <h2>REKAPITULASI ASET LAIN-LAIN TAHUN 2020</h2>
        <div class="buttons">
            <a href="http://web.balikpapan.go.id/uploaded/PPID/Rekap_Penambahan_Aset_Tetap_2020.pdf">
                <button class="download-btn">
                    <i class="bi bi-download"></i> Tautan
                </button>
            </a>
    ...
    <div class="document">
        <h2>REKAPITULASI ASET LAIN-LAIN TAHUN 2019</h2>
        <div class="buttons">
            <a href="http://web.balikpapan.go.id/uploaded/PPID/REKAP_PENAMBAHAN_ASET_TETAP_2019.pdf">
                <button class="download-btn">
                    <i class="bi bi-download"></i> Tautan
                </button>
            </a>
    ...
    <div class="document">
        <h2>REKAPITULASI ASET LAIN-LAIN TAHUN 2018</h2>
        <div class="buttons">
            <a href="http://web.balikpapan.go.id/uploaded/PPID/Daftar_Aset_Tetap_2018.pdf">
                <button class="download-btn">
                    <i class="bi bi-download"></i> Tautan
                </button>
            </a>
    ...
    <div class="document">
        <h2>REKAPITULASI ASET LAIN-LAIN TAHUN 2017</h2>
        <div class="buttons">
            <a href="http://web.balikpapan.go.id/uploaded/ASET_LAINNYA-20171.pdf">
                <button class="download-btn">
                    <i class="bi bi-download"></i> Tautan
                </button>
            </a>
    ...
    <div class="document">
        <h2>REKAPITULASI ASET LAIN-LAIN TAHUN 2016</h2>
        <div class="buttons">
            <a href="http://web.balikpapan.go.id/uploaded/Aset_Lain-lain-2016.pdf">
                <button class="download-btn">
                    <i class="bi bi-download"></i> Tautan
                </button>
            </a>
    ...
    <div class="document">
        <h2>REKAPITULASI ASET LAIN-LAIN TAHUN 2015</h2>
        <div class="buttons">
            <a href="http://web.balikpapan.go.id/uploaded/Aset_lain-lain.pdf">
                <button class="download-btn">
                    <i class="bi bi-download"></i> Tautan
                </button>
            </a>
