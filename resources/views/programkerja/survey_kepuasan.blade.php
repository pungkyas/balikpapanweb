...
<div class="containerr">
    <div class="document">
        <h2>Hasil Survey Kepuasan Masyarakat Tahun 2020</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/Hasil_SKM_2020.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>

    <div class="document">
        <h2>Hasil Survey Kepuasan Masyarakat Tahun 2019</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/Hasil_Survei_Kepuasan_Masyarakat_Tahun_2019_versi_website.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>

    <div class="document">
        <h2>Hasil Survey Kepuasan Masyarakat Tahun 2018</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/REKAP_HASIL_SKM_2018.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>
    <div class="document">
        <h2>Hasil Survey Kepuasan Masyarakat Tahun 2017</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/SKM/REKAP%20HASIL%20SKM%202017.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>
    <div class="document">
        <h2>Hasil Survey Kepuasan Masyarakat Tahun 2016</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/2017/REKAP%20IKM%202016.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>
    <div class="document">
        <h2>Hasil Survey Kepuasan Masyarakat Tahun 2015</h2>
        <div class="buttons">
            <a href="https://web.balikpapan.go.id/uploaded/ProgramKerja/SKM/Rekapitulasi%20Hasil%20SKM%20Tahun%202015.pdf"><button class="download-btn"><i class="bi bi-download"></i> Tautan</button></a></td>
        </div>
    </div>
</section>
