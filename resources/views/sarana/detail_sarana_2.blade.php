...
<style>
    * {
    ...
    .berita-container {
        ...
        width: 100%;
        height: 60vh;
        background: url('assets/img/restoran.png') no-repeat center center/cover;
        display: flex;
        align-items: center;
        color: white;
        padding: 20px;
...
<section class="berita-container">
    ...
    <div class="berita-content">
        ...
        <h1 class="berita-title">Restoran dan Cafe</h1>
...
<section>
    ...
    <div class="containerr">
        <div class="content">
            <img src="assets/img/restoran.png" alt="Berita Utama">
            <h2>Restoran dan Cafe</h2>
            <p>Restoran dan kafe di Balikpapan menawarkan berbagai pilihan kuliner yang memanjakan selera, baik bagi wisatawan maupun penduduk lokal. Banyak restoran di kota ini yang menyajikan hidangan khas Kalimantan Timur, seperti ikan bakar, sate lilit, dan makanan laut segar, yang kaya akan rasa dan cita rasa lokal. Selain itu, ada juga restoran dengan menu internasional, seperti masakan Jepang, Italia, dan Eropa, yang memberikan variasi bagi para pengunjung. Kafe-kafe di Balikpapan juga tidak kalah menarik, dengan suasana yang cozy dan modern, cocok untuk bersantai atau berkumpul dengan teman-teman. Beberapa kafe menawarkan kopi lokal yang khas serta berbagai pilihan pastry dan makanan ringan, sementara yang lain memiliki menu fusion yang menggabungkan citarasa lokal dan internasional. Restoran dan kafe di Balikpapan juga sering menjadi tempat yang ramai untuk acara sosial, pertemuan bisnis, atau sekadar menikmati waktu luang, dengan banyak di antaranya menawarkan pemandangan indah, seperti di tepi pantai atau dengan latar belakang kota yang indah.</p>
        </div>
