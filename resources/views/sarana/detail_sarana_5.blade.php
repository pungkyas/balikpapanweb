...
<style>
    * {
    ...
    .berita-container {
        ...
        width: 100%;
        height: 60vh;
        background: url('assets/img/bank.png') no-repeat center center/cover;
        display: flex;
        align-items: center;
        color: white;
        padding: 20px;
...
<section class="berita-container">
    ...
    <div class="berita-content">
        ...
        <h1 class="berita-title">Bank dan Penukaran Uang</h1>
...
<section>
    <div class="containerr">
        <div class="content">
            <img src="assets/img/bank.png" alt="Berita Utama">
            <h2>Bank dan Penukaran Uang</h2>
            <p>Bank dan layanan penukaran uang di Balikpapan menyediakan fasilitas yang memudahkan wisatawan maupun penduduk lokal untuk melakukan transaksi keuangan dengan nyaman. Bank-bank di kota ini menawarkan berbagai layanan, mulai dari penarikan uang tunai, setoran, transfer antarbank, hingga layanan tabungan dan pinjaman. Beberapa bank juga memiliki fasilitas ATM yang tersebar di berbagai lokasi strategis, memudahkan akses keuangan kapan saja. Selain itu, ada juga beberapa tempat penukaran uang yang khusus melayani pertukaran mata uang asing untuk wisatawan internasional, dengan kurs yang kompetitif. Layanan penukaran uang ini umumnya dapat ditemukan di pusat perbelanjaan, hotel, dan kantor-kantor yang berada di lokasi ramai. Baik bank maupun tempat penukaran uang di Balikpapan memastikan transaksi dilakukan dengan aman dan efisien, memberikan kenyamanan bagi pengunjung yang membutuhkan layanan keuangan selama berada di kota ini.</p>
        </div>
