...
<style>
    * {
    ...
    .berita-container {
        ...
        width: 100%;
        height: 60vh;
        background: url('assets/img/biro.png') no-repeat center center/cover;
        display: flex;
        align-items: center;
        color: white;
        padding: 20px;
...
<section class="berita-container">
    ...
    <div class="berita-content">
        ...
        <h1 class="berita-title">Biro Perjalanan</h1>
...
<div class="containerr">
        <div class="content">
            <img src="assets/img/biro.png" alt="Berita Utama">
            <h2>Biro Perjalanan</h2>
            <p>Biro perjalanan di Balikpapan menawarkan berbagai layanan untuk membantu wisatawan mengeksplorasi keindahan kota dan sekitarnya dengan nyaman dan mudah. Mereka menyediakan paket wisata yang mencakup tur ke tempat-tempat wisata populer seperti Pantai Melawai, Taman Bekapai, dan Bukit Bangkirai, serta destinasi alam lainnya yang memukau, seperti hutan tropis dan air terjun. Selain itu, biro perjalanan juga menawarkan layanan antar-jemput bandara, pengaturan akomodasi di hotel-hotel terbaik, serta penyewaan kendaraan untuk wisatawan yang ingin berkeliling kota dengan fleksibel. Beberapa biro perjalanan juga menyediakan paket khusus untuk perjalanan bisnis, seperti pengaturan konferensi dan event di hotel-hotel ternama. Dengan pengalaman dan pengetahuan tentang destinasi lokal, biro perjalanan di Balikpapan memastikan para wisatawan dapat menikmati liburan atau perjalanan bisnis mereka dengan aman, nyaman, dan tanpa repot.</p>
        </div>
