...
<style>
    * {
    ...
    .berita-container {
        ...
        width: 100%;
        height: 60vh;
        background: url('assets/img/hutanmangrove.png') no-repeat center center/cover;
        display: flex;
        align-items: center;
        color: white;
        padding: 20px;
...
<section class="berita-container">
    ...
    <div class="berita-content">
        ...
        <h1 class="berita-title">Hutan Mangrove</h1>
...
<section>
    <div class="containerr">
        <div class="content">
            <img src="assets/img/hutanmangrove.png" alt="Berita Utama">
            <h2>Hutan Mangrove</h2>
            <p>Hutan mangrove di Balikpapan adalah ekosistem mangrove yang terletak di daerah pesisir Balikpapan, Kalimantan Timur. Hutan mangrove ini berfungsi sebagai penahan abrasi pantai, penghasil oksigen, dan habitat bagi berbagai jenis flora dan fauna, seperti berbagai spesies burung, ikan, dan udang.

                Salah satu kawasan yang terkenal adalah Kawasan Konservasi Mangrove dan Bekantan (KKMB) yang berlokasi di sekitar Teluk Balikpapan. Hutan mangrove di Balikpapan juga memiliki peran penting dalam menjaga keseimbangan ekosistem pesisir serta mendukung keberlanjutan kehidupan masyarakat sekitar yang bergantung pada sumber daya alam pesisir.

                Selain manfaat ekologisnya, hutan mangrove ini juga memiliki potensi untuk menjadi destinasi wisata alam, di mana pengunjung dapat menikmati keindahan alam sambil belajar tentang pentingnya konservasi mangrove dan perlindungannya terhadap lingkungan.</p>
        </div>
