...
<style>
    * {
    ...
    .berita-container {
        ...
        width: 100%;
        height: 60vh;
        background: url('assets/img/kwlph.png') no-repeat center center/cover;
        display: flex;
        align-items: center;
        color: white;
        padding: 20px;
...
<section>
    ...
    <div class="containerr">
        <div class="content">
            <img src="assets/img/kwlph.png" alt="Berita Utama">
            <h2>KWLPH Beruang Madu</h2>
            <p>Kawasan Wisata Pendidikan Lingkungan Hidup (KWPLH), atau yang dikenal sebagai Pusat Beruang Madu, adalah sebuah fasilitas pendidikan lingkungan hidup yang terletak 23 km di sebelah utara kota Balikpapan, Kalimantan Timur, Indonesia.
                ...
                Hingga sampai saat ini pembangunan KWPLH secara luas didanai melalui donasi-donasi, sedangkan biaya operasional dasar didanai oleh Pemerintah Kota. KWPLH saat ini mempekerjakan 41 pegawai, dimana 80% dari itu adalah warga sekitar.</p>
        </div>
